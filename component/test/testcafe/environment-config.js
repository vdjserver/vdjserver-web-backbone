...
export var EnvironmentConfig = {
    'agave': {
        ...
        'internal': 'https://vdj-agave-api.tacc.utexas.edu',
    ...
    'adc': {
        ...
        'vdjbase': {
            'title': 'VDJbase',
            'hostname': 'http://airr-seq.vdjbase.org',
            'adc_path': '/airr/v1',
            //'stats_path': '/irplus/v1/stats'
        },
        'ipa1': {
        ...
        'ipa5': {
            'title': 'IPA',
            'hostname': 'http://ipa5.ireceptor.org',
            'adc_path': '/airr/v1',
            //'stats_path': '/irplus/v1/stats'
        },
        'covid19-1': {
            'title': 'IPA',
            'hostname': 'http://covid19-1.ireceptor.org',
            'adc_path': '/airr/v1',
            //'stats_path': '/irplus/v1/stats'
        },
        'covid19-2': {
            'title': 'IPA',
            'hostname': 'http://covid19-2.ireceptor.org',
            'adc_path': '/airr/v1',
            //'stats_path': '/irplus/v1/stats'
        },
        'covid19-3': {
            'title': 'IPA',
            'hostname': 'http://covid19-3.ireceptor.org',
            'adc_path': '/airr/v1',
            //'stats_path': '/irplus/v1/stats'
        },
        'covid19-4': {
            'title': 'IPA',
            'hostname': 'http://covid19-4.ireceptor.org',
            'adc_path': '/airr/v1',
            //'stats_path': '/irplus/v1/stats'
        },
    },
    ...
    'vdjGuest': {
        'hostname': 'https://vdj-staging.tacc.utexas.edu/guest',
    },
    'test': {
        'username': 'apitest',
        'password': '',
